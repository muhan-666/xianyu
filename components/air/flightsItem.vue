                ...
                <el-col :span="12">
                    <el-row type="flex" justify="space-between" class="flight-info-center">
                        <el-col :span="8" class="flight-airport">
                            ...
                            <span>{{data.org_airport_name}}{{data.org_airport_query}}</span>
                        </el-col>
                        ...
                        <el-col :span="8" class="flight-airport">
                            ...
                            <span>{{data.dst_airport_name}}{{data.dst_airport_query}}</span>
                        </el-col>
                    </el-row>
                </el-col>
                ...
                <el-col :span="20">
                    <el-row type="flex" justify="space-between" align="middle" class="flight-sell">
                        ...
                        <el-col :span="3" class="choose-button">
                            <el-button type="warning" size="mini" @click="handleLinkOrder(data.id, item.seat_xid)">
                                选定
                            </el-button>
    ...
    export default {
        ...
        computed: {
            countTime() {
                ...
                const newdep = dep.split(':')
                //[0]是小时,[1]是分钟 
                let end = newarr[0] * 60 + +newarr[1]
                const start = newdep[0] * 60 + +newdep[1]
                // console.log(+newdep[1])
